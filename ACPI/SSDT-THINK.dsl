...
{
    External (_SB.PCI0.LPC0.EC0, DeviceObj)    // EC path
    External (_SB.PCI0.LPC0.EC0.HKEY, DeviceObj)    // HKEY path
    External (_SB.PCI0.LPC0.EC0.HFSP, FieldUnitObj)    // Fan control register
    External (_SB.PCI0.LPC0.EC0.HFNI, FieldUnitObj)    // Fan control register
    External (_SB.PCI0.LPC0.EC0.VRST, FieldUnitObj)    // Second fan switch register
